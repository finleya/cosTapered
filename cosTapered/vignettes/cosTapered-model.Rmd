...
A longer set of modeling notes is installed with the package as
[modeling_notes.pdf](../guiding_docs/modeling_notes.pdf), with the LaTeX
source included in the same installed `guiding_docs` directory.
