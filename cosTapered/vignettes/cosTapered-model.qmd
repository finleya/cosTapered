...
- `target = "latent"` summarizes the underlying support mean on the model
  scale.
- `target = "observed"` adds the Gaussian nugget contribution on the requested
  support: fine-cell nugget variation for fine predictions and support-averaged
  nugget variation for areal predictions. This option is currently for Gaussian
  fits.
